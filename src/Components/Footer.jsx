  ...
  return (
    <footer className="w-full bg-[#5B2D7C] text-white pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="text-center md:text-left">
          <img
            ...
            className="w-32 mx-auto rounded  md:mx-0"
          />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/student-portal" className="hover:text-gray-300">Student Portal</Link></li>
            ...
            <li><Link to="/admission" className="hover:text-gray-300">Admission</Link></li>
      ...
      <div className="mt-8 border-t border-gray-500 pt-4 text-center text-sm">
        ...
        <p className="text-xs mt-1">Designed with ❤️ by <a href="https://www.webfloratechnologies.com/">Webflora Technologies</a></p>
      </div>
    </footer>
  );
}
